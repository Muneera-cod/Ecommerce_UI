    ...
    <div className='flex sm:flex-col lg:flex-row '>
        <div className='basis-1/2  flex flex-col  items-stretch'>
           <div className='flex sm:flex-col lg:flex-row sm:px-[16px] lg:px-[0] sm:py-[40px] lg:py-[0] gap-[24px] items-center justify-center items-stretch h-full w-full'>
                ...
                <div className='flex flex-col sm:items-center lg:items-start justify-center  sm:p-[24px] lg:p-[48px] gap-[16px] sm:text-center lg:text-left'>
           ...
           <div className='flex  sm:flex-col lg:flex-row items-stretch h-full w-full'>
               <div className='flex bg-secondaryClr sm:flex-col lg:flex-row sm:px-[16px] lg:px-[0] sm:py-[40px] lg:py-[0] gap-[24px] items-center '>
                  <img src={AirPod}></img>
                  <div className='flex flex-col sm:items-center lg:items-start justify-center sm:p-[24px] lg:p-[48px] sm:text-center lg:text-left'>
               ...
               <div className='flex bg-[#353535] sm:flex-col lg:flex-row sm:px-[16px] lg:px-[0] sm:py-[40px] lg:py-[0] gap-[24px]  items-center'>
                  <img src={AppleVissionPro} className=''></img>
        ...
        <div className='basis-1/2 bg-secondaryClr flex py-[44px] sm:pr-[56px] lg:pr-[0] pl-[56px] justify-between items-center sm:flex-col-reverse  lg:flex-row'>
